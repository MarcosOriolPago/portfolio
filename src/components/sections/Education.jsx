            ...
            <RevealOnScroll key={index}>
              <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 lg:p-8 transition-colors duration-300 hover:border-white/[0.14] hover:bg-white/[0.03]">
                <div className="flex items-start gap-4">
                  <div className="mt-1 shrink-0 flex items-center justify-center w-18 h-18 rounded-xl bg-blue-500/10 border border-blue-500/20">
                    <img src={entry.logo} alt={`${entry.institution} logo`} className="absolute w-12 h-12 object-contain" />
                  </div>

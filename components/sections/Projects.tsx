      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <ProjectCard
            ...
            detailedDescription={
              <InnerProjectDescription>
                ...
                <OptimizedImage
                  src="img/snnverse.webp"
                  alt="SNNverse builder interface"
                  width={800}
                  height={450}
                  quality={70}
                  className="rounded-xl border border-white/10 mb-3 w-full h-auto"
                />
          ...
          <ProjectCard
            ...
            detailedDescription={
              <InnerProjectDescription>
                ...
                <OptimizedImage
                  src="img/overview_workflow.webp"
          ...
          <ProjectCard
            ...
            image="img/neurogait-results.webp"
            ...
            detailedDescription={
              <InnerProjectDescription>
                ...
                <OptimizedImage
                  src="img/neurogait-pipeline.webp"
                ...
                <OptimizedImage
                  src="img/neurogait-results.webp"
